...
(function (global, factory) {
  ...
  var TooltipUI = /** @class */ (function () {
      ...
      if (this.options.trigger !== 'manual') {
        ...
        this.options.trigger.split(' ').forEach(function (eventName) {
          if (eventName === 'hover') {
            ...
            $node.on('mouseenter', showCallback_1).on('mouseleave',
                hideCallback_1);
          }
    ...
    TooltipUI.prototype.show = function () {
      ...
      var title = this.options.title || $node.attr('title') || $node.data(
          'title');
  ...
  var ModalUI = /** @class */ (function () {
    ...
    ModalUI.prototype.show = function () {
      ...
      this.$modal.off('click', '.close').on('click', '.close',
          this.hide.bind(this));
    };
  ...
  var button = renderer.create('<button type="button" class="note-btn">',
  ...
  var dropdown = renderer.create('<div class="note-dropdown-menu">',
      function ($node, options) {
        var markup = $.isArray(options.items) ? options.items.map(
            function (item) {
  ...
  var dropdownCheck = renderer.create(
      '<div class="note-dropdown-menu note-check">', function ($node, options) {
        var markup = $.isArray(options.items) ? options.items.map(
            function (item) {
              var value = (typeof item === 'string') ? item : (item.value
                  || '');
              ...
              var $temp = $(
                  '<a class="note-dropdown-item" href="#" data-value="' + value
                  + '"></a>');
              $temp.html([icon(options.checkClassName), ' ', content]).data(
                  'item', item);
              return $temp;
            }) : options.items;
        $node.html(markup);
      ...
      children: [
        ...
        dropdown({
          items: [
            ...
            '  <div class="note-palette-title">' + opt.lang.color.background
            + '</div>',
            '  <div>',
            ...
            '  <div class="note-palette-title">' + opt.lang.color.foreground
            + '</div>',
            '  <div>',
            '<button type="button" class="note-color-reset note-btn note-btn-block" '
            +
  ...
  var dialog = renderer.create('<div class="note-modal" tabindex="-1"/>',
      function ($node, options) {
        if (options.fade) {
          $node.addClass('fade');
        }
        $node.html([
          ...
          (options.footer
              ? '    <div class="note-modal-footer">' + options.footer
              + '</div>' : ''),
          '  </div>'
        ].join(''));
  ...
  var imageDialog = function (opt) {
    var body = '<div class="note-form-group note-group-select-from-files">' +
        '<label class="note-form-label">' + opt.lang.image.selectFromFiles
        + '</label>' +
  ...
  var linkDialog = function (opt) {
    var body = '<div class="note-form-group">' +
        '<label class="note-form-label">' + opt.lang.link.textToDisplay
        + '</label>' +
        ...
        (!opt.disableLinkTarget
            ...
            + opt.lang.link.openInNewWindow + '</label>' +
            '</div>' : '');
    var footer = [
  ...
  function isFontInstalled(fontName) {
    ...
    var width = $tester.css('fontFamily',
        fontName + ',' + testFontName).width();
    $tester.remove();
...
// - see: https://goo.gl/4bfIvA
  ...
  function isVoid(node) {
    return node && /^BR|^IMG|^HR|^IFRAME|^BUTTON|^INPUT/.test(
    ...
    WrappedRange.prototype.normalize = function () {
      ...
      var getVisiblePoint = function (point, isLeftToRight) {
        if ((dom.isVisiblePoint(point) && !dom.isEdgePoint(point)) ||
            (dom.isVisiblePoint(point) && dom.isRightEdgePoint(point)
                && !isLeftToRight) ||
            (dom.isVisiblePoint(point) && dom.isLeftEdgePoint(point)
                && isLeftToRight) ||
            (dom.isVisiblePoint(point) && dom.isBlock(point.node)
  ...
  var Style = /** @class */ (function () {
    ...
    Style.prototype.current = function (rng) {
      ...
      if (!rng.isOnList()) {
        ...
        var isUnordered = $$1.inArray(styleInfo['list-style-type'],
            orderedTypes) > -1;
  ...
  var Typing = /** @class */ (function () {
    ...
    Typing.prototype.insertParagraph = function (editable) {
      ...
      if (splitRoot) {
        ...
        else if (dom.isEmpty(splitRoot) && dom.isPara(splitRoot)
  ...
  var CodeView = /** @class */ (function () {
    ...
    CodeView.prototype.deactivate = function () {
      ...
      var value = dom.value(this.$codable, this.options.prettifyHtml)
          || dom.emptyPara;
  ...
  var Buttons = /** @class */ (function () {
    ...
    Buttons.prototype.isFontDeservedToAdd = function (name) {
      ...
      return ((name !== '') && this.isFontInstalled(name) && ($$1.inArray(name,
          genericFamilies) === -1));
    };
          ...
          children: [
            ...
            _this.ui.dropdown({
              items: [
                ...
                + _this.lang.color.background + '</div>',
                '  <div>',
                ...
                '<div class="note-palette">',
                '  <div class="note-palette-title">'
                + _this.lang.color.foreground + '</div>',
                '  <div>',
    ...
    Buttons.prototype.build = function ($container, groups) {
      for (var groupIdx = 0, groupLen = groups.length; groupIdx < groupLen;
        ...
        var buttons = $$1.isArray(group) ? ((group.length === 1) ? [group[0]]
            : group[1]) : [group];
  ...
  var Toolbar = /** @class */ (function () {
    ...
    Toolbar.prototype.followScroll = function () {
      ...
      var deactivateOffsetBottom = editorOffsetBottom - otherBarHeight
          - toolbarHeight;
      if ((currentOffset > activateOffset) && (currentOffset
  ...
  var LinkDialog = /** @class */ (function () {
    ...
    LinkDialog.prototype.initialize = function () {
      ...
      var footer = "<button type=\"submit\" href=\"#\" class=\"" + buttonClass
          + "\" disabled>" + this.lang.link.insert + "</button>";
  ...
  var ImageDialog = /** @class */ (function () {
    ...
    ImageDialog.prototype.initialize = function () {
      ...
      var footer = "<button type=\"submit\" href=\"#\" class=\"" + buttonClass
          + "\" disabled>" + this.lang.image.insert + "</button>";
      this.$dialog = this.ui.dialog({
  ...
  var VideoDialog = /** @class */ (function () {
    ...
    VideoDialog.prototype.initialize = function () {
      ...
      var footer = "<button type=\"submit\" href=\"#\" class=\"" + buttonClass
          + "\" disabled>" + this.lang.video.insert + "</button>";
      this.$dialog = this.ui.dialog({
